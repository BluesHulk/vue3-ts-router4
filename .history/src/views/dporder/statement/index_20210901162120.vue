    ...
    >
      ...
      >
        ...
        <el-row>
          ...
          <!-- <el-form-item label="单据状态" prop="isActive">
            <el-select
...
<script>
  import {
    ...
    getDporderStatementOrderList,
    getDporderStatementSalesOrderList,
    addDporderStatement,
    updateAuditStatus,
  ...
  export default {
    ...
    methods: {
        ...
        this.$refs['updateForm'].validate((valid) => {
          if (valid) {
            if (this.statementTableChoose.length > 0) {
              ...
              addDporderStatement(this.statementForm).then((res) => {
                if (res.status == '0') {
                  this.$message({
                    type: 'success',
                    message: '对账成功!',
              ...
              //   //销售对账单
              //   getDporderStatementOrderList(this.statementForm).then((res) => {
              //     if (res.status == '0') {
              //       this.$message({
              //         type: 'success',
              //         message: '对账成功!',
      ...
      getDporderStatementOrderDataList() {
        ...
        if (this.businessType == 1) {
          this.orderPage.param['salesOrderCode'] =
            this.orderPage.param.purchaseOrderCode
          getDporderStatementSalesOrderList(this.orderPage).then((res) => {
            if (res.status == 0) {
          ...
          getDporderStatementOrderList(this.orderPage).then((res) => {
            if (res.status == 0) {
              this.statementTableList = res.data || []
            } else {
              this.$message.error(res.message)
