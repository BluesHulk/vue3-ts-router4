    ...
    children: [
      {
        path: 'ptdriver',
        name: 'ptdriver',
        component: '@/views/operation/driver',
        meta: {
          title: '司机管理',
          icon: 'admin-line',
          level: 2,
      ...
      },
      {
        path: 'ptproduct',
        name: 'ptproduct',
        component: '@/views/operation/product',
        meta: {
          title: '物料档案',
          icon: 'home-2-line',
          level: 2,
      ...
      },
      {
        ...
        component: '@/views/operation/productCategory',
        meta: {
          title: '物料分类档案',
          icon: 'home-2-line',
          level: 2,
    ...
    children: [
      {
        path: 'sale',
        name: 'sale',
        component: '@/views/schedules/sale/index.vue',
        meta: {
          title: '销售计划分配',
          icon: 'user-3-line',
        },
