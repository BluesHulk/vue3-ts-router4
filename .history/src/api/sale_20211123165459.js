...
//销售订单列表 修改派车单计量模式
export function updateCalculateMode(data) {
  return request({
    url: prefixBusiness + "/co/salesOrder/updateCalculateMode",
    method: "post",
    data,
  });
}
...
//订单明细列表
export function queryOrderDetailsList(data) {
  return request({
    url: prefixBusiness + "/orderDetails/queryOrderDetailsList",
    method: "post",
    data,
  });
}
...
//订单明细 销售推送
export function sendNcByPurchaseManualSales(data) {
  return request({
    url: prefixBusiness + "/orderDetails/sendNcBySalesManual",
    method: "post",
    data,
  });
}
...
//订单明细 采购推送
export function sendNcByPurchaseManual(data) {
  return request({
    url: prefixBusiness + "/orderDetails/sendNcByPurchaseManual",
    method: "post",
    data,
  });
}
//订单明细 采购明细手动发送NC-删除
export function sendNcByPurchaseManualDel(data) {
  return request({
    url: prefixBusiness + "/orderDetails/sendNcByPurchaseManualDel",
    method: "post",
    data,
  });
}
...
//订单明细 销售明细手动发送NC-删除
export function sendNcBySalesManualDel(data) {
  return request({
    url: prefixBusiness + "/orderDetails/sendNcBySalesManualDel",
    method: "post",
    data,
  });
}
...
//新建补单接口
export function salesOrdersaveExtraOrder(data) {
  return request({
    url: prefixBusiness + "/co/salesOrder/saveExtraOrder",
    method: "post",
    data,
  });
}
